...
if a!="Rendy":
	...
	print(colored(f"Пароль верен! Запускаю работу программы, и не забудь !", 'green'))

# ASCII-арт приветствия для проги
ascii_banner = pyfiglet.figlet_format("RENDY ")
colored_banner = colored(ascii_banner, color='red')  # Красим в цвет
print('Приватный сносер от канала Rendy Softs')
print('-------------------------------------------------------------')
...
def complaint():
	...
	print(colored("[3] Оскорбление","red"))
	print(colored("[4] Нарушение правил", "magenta"))
	print(colored("[5] Сессий", "red"))
	print(colored("[6] Спам", "magenta"))
	print(colored("[7] Прайс", "red"))
	print(colored("[8] Накрутка", "magenta"))
	complaint_choice = input(colored("Введите номер: ", "blue"))
